...
<body>
    ...
    <div class="upper_wrapper">
        ...
        <div class="location_box">
            ...
            <div class="user_data">{{$user->address}}</div>
        </div>
        ...
        <a href="profile-edit-user"><div class="edit_button"><img class="edit_icon" src="https://img.icons8.com/metro/26/ffffff/edit.png"/></div></a> 
    </div>

    <div class="ordersnfav">
            <p>
                <button class=" btn_profile" type="button" data-toggle="collapse" data-target="#multiCollapseExample1" aria-expanded="false" aria-controls="multiCollapseExample1">My Cakes</button>
                <button class=" btn_profile" type="button" data-toggle="collapse" data-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">Favorites</button>
            </p>
