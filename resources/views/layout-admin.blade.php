        ...
        <div class="sidebar">
            ...
            <div class="container">
                <div class="sidebar_contents">
                    <li><a class="sidebar_link home" href="categories-admin">Categories</a></li>
                    <li><a class="sidebar_link popular_cakes" href="inbox-admin">Inbox</a></li>
                    <li><a class="sidebar_link birthday_cakes" href="profile-admin">Profile</a></li>
                </div>
            </div>
